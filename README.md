...
#### 최성장: LLM을 이용하여 사람들에게 편의를 제공하는 웹을 만드는 경험을 하는게 정말 중요하다고 생각했었는데, 이번 프로젝트에서 Django와Langchain,LLM,AWS EC2 서버를 이용해 카드 추천 챗봇 웹을 구현하여 경험치를 쌓을 수 있어서 정말 값진 시간이라고 생각합니다.<br/>
